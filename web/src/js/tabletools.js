// Quick and simple export target #table_class into a csv
function download_table_as_csv(table_class, separator = ',') {
    ...
    // Download it
    var filename = 'export_' + table_class + '_' + new Date().toLocaleDateString() + '.csv';
